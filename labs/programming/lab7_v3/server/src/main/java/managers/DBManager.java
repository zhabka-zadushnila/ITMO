...
public class DBManager {
    ...
    public SQLAnswer registerUser(String login, String password) {
        ...
        try {
            ...
            parts = line.split(":");
            Connection connection = DriverManager.getConnection(url, parts[3], parts[4]);
        ...
        try (Connection connection = DriverManager.getConnection(url, parts[3], parts[4]); PreparedStatement statement = connection.prepareStatement(sqlInsert)) {
